...
import { chooseLinesLG, chooseLinesSM } from "../../../constants/aria/welcome.js";
...
const Choose = () => {
    ...
    useGSAP(() => {
        ...
        // Will be replaced with CSS-based animations
        ...
        // Text reveal animation (simplified without SplitText)
        tl.to(
            ".choose-title-clip",
            {
        ...
        <section className="choose-section w-full h-dvh p-8 pt-10" style={{ background: 'linear-gradient(to bottom, #181717 0%, #181717 50%, #1f1d1b 65%, #1f1d1b 75%, #1f1d1b 85%, #1f1d1b 90%, #2b2825 100%)' }}>
            ...
            <div className="choose-sec w-full flex lg:flex-row flex-col justify-center items-start gap-10 lg:mt-0">
                <div className='lg:w-1/2 w-full text-[#b1a696] lg:text-[2rem] text-[1rem] md:leading-[1.1] lg:mt-0 mt-8 lg:pr-16'>
                    <p>ARIA uses a 5-layer multi-agent pipeline powered by Gemini. Each layer has a specialized role—from understanding your intent to executing actions with pixel-perfect precision via WebRTC.</p>
                </div>
                <div className='lg:w-1/2 w-full'>
                    <div className=" lg:w-[30%] w-[60%]">
                        <p className="text-[.7rem] text-[#eae5dd]">ARIA® is built on these core principles:</p>
                    </div>
