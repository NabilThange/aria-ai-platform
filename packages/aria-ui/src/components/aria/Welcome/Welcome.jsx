        ...
        <div className='welcome-section w-full h-[120vh] text-[#2A2725]  md:px-7 px-6' style={{ backgroundColor: '#181717' }}>
            ...
            <div className="flex md:flex-row flex-col justify-between items-center md:p-4 md:mt-20 mt-10">
                <div className="flex flex-row justify-center items-center gap-1">
                    <img src="/aria-assets/welcome-1.png" alt="welcome image" className="md:rounded-[8rem] rounded-[9rem] md:w-56 w-44" />
                    <img src="/aria-assets/welcome-2.png" alt="welcome image" className="md:rounded-[8rem] rounded-[9rem] md:w-56 w-44" />
                </div>
