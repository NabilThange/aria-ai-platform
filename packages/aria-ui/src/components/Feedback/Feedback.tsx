...
const reviewImages: Record<string, string> = {
  review1: "/assets/review1.png",
  review2: "/assets/review2.png",
  review3: "/assets/review3.png",
};
...
const Feedback = () => {
  ...
  return (
    <section className="w-full h-dvh p-8 flex flex-col justify-center items-center" style={{ backgroundColor: '#181717' }}>
